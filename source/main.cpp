...
// least squares formula for attaining the getting of best fit
// param: vector of points where each pair is {x, y}
// return: {b, m} in the line y=mx+b
...
// needed named window of normal size because otherwise the image is too big for my screen
...
auto main() -> int {
  ...
  // find the ratios of consecutive slopes of the points
  ...
  // after sorting, the one with the least ratio is rightmost of left side, and one with most ratio is leftmost of right side
  ...
  // draw line through each point to make sure that I have the correct left and right sides
  ...
  // perform least squares regression and output image
